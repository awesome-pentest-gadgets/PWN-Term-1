...
public class LorieService extends Service {
    ...
    static final String ACTION_STOP_SERVICE = "hilled.pwnx11.service_stop";
    static final String ACTION_START_FROM_ACTIVITY = "hilled.pwnx11.start_from_activity";
    static final String ACTION_START_PREFERENCES_ACTIVITY = "hilled.pwnx11.start_preferences_activity";
    static final String ACTION_PREFERENCES_CHAGED = "hilled.pwnx11.preferences_changed";
