package hilled.pwnterm.framework.database;

import hilled.pwnterm.framework.database.annotation.Ignore;
import hilled.pwnterm.framework.database.annotation.NotNull;
