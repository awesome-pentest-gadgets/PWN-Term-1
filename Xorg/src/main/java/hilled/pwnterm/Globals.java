...
public class Globals {
  ...
  public static String DataDir = "/data/data/hilled.pwnterm/files/usr/share/xorg-neoterm";
  public static String UnSecureDataDir = "/data/data/hilled.pwnterm/files/usr/share/xorg-neoterm";
  public static String HomeDir = "/data/data/hilled.pwnterm/files/home";
